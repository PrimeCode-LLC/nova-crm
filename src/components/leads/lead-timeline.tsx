...
const ICONS: Record<TimelineEventType, LucideIcon> = {
  ...
  email_auto_replied: MailWarning,
  email_opened: Eye,
...
const TONES: Record<TimelineEventType, string> = {
  ...
  email_auto_replied: "bg-amber-500/10 text-amber-700 dark:text-amber-400 border-amber-500/20",
  email_opened: "bg-sky-500/10 text-sky-800 dark:text-sky-300 border-sky-500/20",
