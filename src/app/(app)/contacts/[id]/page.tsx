...
import { getContactById, getAccountById, mockLeads } from "@/lib/mock-data";
...
export default async function ContactDetailPage({
  ...
  const leads = mockLeads.filter((l) => l.contactId === contact.id);
              ...
              <CardContent className="pt-0 space-y-2 text-sm">
                ...
                {contact.linkedin && (
                  <div className="flex items-center gap-2">
                    ...
                    <a href={contact.linkedin} target="_blank" rel="noreferrer" className="truncate hover:text-primary text-primary/80">
